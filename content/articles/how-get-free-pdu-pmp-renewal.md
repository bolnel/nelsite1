+++
title = "Ways to Get PDUs: Renew Your PMP in a Sustainable Way"
description = "Breaking down the PMI Talent Triangle and exploring ways of earning Professional Development Units via self-education and various activities."
date = "2025-12-01"
lastmod = "2025-12-01"
slug = "how-get-free-pdu-pmp-renewal"
featured = "/article_images/how-get-free-pdu-pmp-renewal-hero.jpg"
thumbnail = "/article_images/how-get-free-pdu-pmp-renewal-thumbnail.jpg"
tags = []
draft = false
categories = ["Professional growth"]
+++

There are some professional certifications that only require you to pass the exam once, and you keep the credential for life, like [Professional Scrum Master](/articles/psm-1-certification-exam-preparation/).
...
{{< figure src="/article_images/how-get-free-pdu-pmp-renewal-hero.jpg" alt="Ways to get PDUs to renew the PMP certification" caption="photo by \@vlada-karpovich on Pexels">}}

{{< table_of_contents >}}

## Three types of PDUs: PMI Talent Triangle explained

[Talent Triangle](https://www.pmi.org/certifications/certification-resources/maintain/talent-triangle) divides PDUs into three domains, each representing a side of a well-rounded project manager’s skill set. For PMP renewal, you’ll need to get at least 8 PDUs related to each one, for a grand total of 60 every three years.

Same renewal principles apply to CAPM, [DASSM](/articles/disciplined-agile-certifications-dassm/) and other certifications by PMI (with varying renewal cycle times and PDU volume requirements). But I'll be referring to PMP here, as it's the most popular one.
...
The key point is that you need to have a **certificate of completion** that confirms your hours of training. You’ll have to provide it in your PMP application, and it would especially matter if [you get audited during your PMP application process](/articles/how-pass-pmp-audit-pmi/). Any kind of self-education doesn’t count as contact hours.


### PDUs: required for certification maintenance

Professional Development Unit (PDU) is an hour spent learning, volunteering, and doing other activities related to project management work and education **after **you obtain your PMP, CAPM, PMI-ACP, or another PMI credential. You could start logging them in your dashboard right after [you pass the exam successfully](/articles/how-pass-certification-exam-test-first-try-tips-techniques/) and your PMP status is confirmed.
...
{{< figure src="/article_images/how-get-free-pdu-pmp-renewal-img1.jpg" alt="Studying is an important aspect of staying relevant as a project manager" caption="photo by \@ivan-s on Pexels">}}


## Giving back – log PDUs for working as a PM
...
The “Giving back” area is fully optional and allows you to earn up to 25 PDUs for sharing your knowledge and contributing to the profession. You could log hours for activities like writing articles, volunteering, [leading study groups](/articles/start-successful-study-group-online-challenges-tips-guide/), and so on.
...
PMI has their own resource, [Projectmanagement.com](http://Projectmanagement.com), which hosts over two thousand webinars. The majority are PMI members-only, but there are still hundreds of webinars for non-members, so you would definitely find a few dozen that are of interest to you personally.

If you watch a webinar on [Projectmanagement.com](http://Projectmanagement.com) in its entirety, a PDU is automatically logged into your account. It’ll reflect on your dashboard within 48 hours.

Webinars from other sources also count. There are great project management podcast playlists on Youtube, and I also have a list of [12 project management and Scrum webinars](/articles/free-scrum-agile-webinars-prepare-certification-exam/) compiled while I was getting ready for the [PSM II exam](/articles/psm-2-certification-exam-preparation/).
...
PMI has a number of “free” courses that give a few PDUs each. Most of them are actually only zero-cost if you have a paid PMI membership, but some are free for everyone, like a course on [application of Generative AI](https://www.pmi.org/shop/tc/p-/elearning/practical-application-of-generative-ai-for-project-managers/el173).
...
## Obtain PDUs by reading books and articles
...
Look at the Talent Triangle domains and think which materials and activities could help you develop those skills in the next few months. Be [consistent and strategic](/articles/how-improve-consistency-tips-guide/) about it, and you’ll gain enough PDUs before you know it, and will take pleasure in doing so.
...
However, if you don't take action within a year, the credential lapses completely, so you'll need to pay the full exam price and go through the whole [PMP earning process](/articles/pmp-certification-exam-preparation/) all over again.
