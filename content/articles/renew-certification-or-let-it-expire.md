...
**Microsoft **role-based and specialty certifications [are good for one year](https://learn.microsoft.com/en-us/credentials/support/credential-expiration-policy), but the renewal is free and easy. Their fundamentals certifications are good for life. Microsoft removed the recertification requirements for a few of their specialized credentials, [only to retire half of them](https://learn.microsoft.com/en-us/certifications/posts/mcsa-mcsd-mcse-certifications-retire-with-continued-investment-to-role-based-certifications) to focus more on role-based training and certifications.
